...
public class DecentScrollbar extends Canvas implements MouseListener,
		MouseMotionListener
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 5167785343513065608L;
	int value, lo, hi;
	DecentScrollbarListener listener;

	public DecentScrollbar(DecentScrollbarListener parent, int start, int lo_, int hi_)
	{
		value = start;
		lo = lo_;
		hi = hi_;
